  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Shelby Barbers</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Shelby Barbers in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Shelby Barbers | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Shelby Barbers | Premium Barbershop Berlin" />
        <meta
